...
public class MatrixMultiply {
  ...
  static public void multiplyMatrices(double[][] newMatrice, int left, int right){
  ...
  public static void main(String[] args){
    ...
    Thread worker1 = new Thread(() -> multiplyMatrices(newMatrice, 0, 500));
    Thread worker2 = new Thread(() -> multiplyMatrices(newMatrice, 500, 1000));
    ...
    multiplyMatrices(matriceSingleThread, 0, 1000);
